...
### Preferred Method
1. Use the GitHub Security Advisory ["Report a Vulnerability"](https://github.com/ericsizemore/phpunit-coverage-check/security/advisories/new) tab.
...
You can view our past security advisories here on [GitHub](https://github.com/ericsizemore/phpunit-coverage-check/security/advisories).
